...
# 13.11 Theoretical conticuous distributions
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/plot-of-height-frequencies-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/intergrals-1.png)
...
# 13.12 Monte Caro simulations for conticuous variables
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-heights-1.png)
...
Having a seven footer is puite rare:
```{r}
mean(tallest>=7*12)
```

Here is the resulting distribution:
[link](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-tallest-height-1.png)

Note that it does not look normal.

# 13.13 Continuous distribution
...
pnorm(in_to_cm(67), in_to_cm(64), in_to_cm(3)) - pnorm(in_to_cm(61), in_to_cm(64), in_to_cm(3))
```
same as the above.
...
```{r}
#The default sd=1 in pnorm function.
pnorm(1)-pnorm(-1)
```
...
B=1000
highest<-replicate(B, {
  sample_data<-rnorm(10000, 100, 15)
  max(sample_data)
})
qplot(highest, bins=30)
```
