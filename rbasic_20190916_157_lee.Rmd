...
```
-3 is FALSE so "Not all positives" is return.
...
8. fine an empty numerical vector s_n of size 25 using s_n <- vector("numeric", 25) and store in the results of S1, S2, …, S25 using a for-loop.
