---
title: "Ch 11 Data visualization principles"
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/piechart-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/donutchart-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/two-barplots-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/excel-barplot-1.png)
...
[link](https://rafalab.github.io/dsbook/dataviz/img/class2_8.jpg)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-from-zero-1-1.png)

Here is another example, described in detail in this Flowing Data blog post
[link](https://rafalab.github.io/dsbook/dataviz/img/Bush-cuts.png)

This plot makes a 13% increase look like a five-fold change. Here is the appropriate plot:
[link](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-from-zero-2-1.png)

Finally, here is an extreme example that makes a very small difference of under 2% look like a 10-100 fold change:
[link](https://rafalab.github.io/dsbook/dataviz/img/venezuela-election.png)

Here is the appropriate plot:
[link](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-from-zero-3-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/points-plot-not-from-zero-1.png)
...
[link](https://rafalab.github.io/dsbook/dataviz/img/class2_30.jpg)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/area-not-radius-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-better-than-area-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/do-not-order-alphabetically-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/reorder-boxplot-example-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/show-data-1-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/common-axes-histograms-wrong-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/common-axes-histograms-right-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/show-the-data-comparison-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/no-transformations-wrong-use-of-barplot-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/no-transformation-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/correct-transformation-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/boxplots-not-adjacent-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/boxplot-adjacent-comps-1.png)

## 11.6.5 Use color

The comparison becomes even easier to make if we use color to denote the two things we want to compare:
[link](https://rafalab.github.io/dsbook/book_files/figure-html/boxplot-adjacent-comps-with-color-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/scatter-plot-instead-of-slope-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/encoding-third-variable-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/available-shapes-1.png)
...
[link](https://rafalab.github.io/dsbook/dataviz/img/fig8b.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/colors-for-different-lines-1.png)
...
[link](https://rafalab.github.io/dsbook/dataviz/img/fig1e.png)
[link](https://rafalab.github.io/dsbook/dataviz/img/fig2d.png)
...
Useful ways to change the number of significant digits or to round numbers are signif and round. You can define the number of significant digits globally by setting options like this:
```{r}
options(digits=3)
```
...
[11.13-1](https://rafalab.github.io/dsbook/book_files/figure-html/baplot-not-from-zero-exercises-1.png)
...
[11.13-2](https://rafalab.github.io/dsbook/book_files/figure-html/measels-exercise-1.png)
...
[11.13-3](https://rafalab.github.io/dsbook/book_files/figure-html/pseudo-3d-exercise-1.png)
...
[11.13-4](https://rafalab.github.io/dsbook/book_files/figure-html/pseud-3d-exercise-2-1.png)
...
us_contagious_diseases %>%  
  ...
  geom_line()
#...??? is this right..? Author really want this?
```
...
us_contagious_diseases%>%
  ...
  geom_line()+
  scale_y_continuous(trans='sqrt')
#Author want this things too..? I didn't catch his intention...
```
...
```{r}
#All kinds of plot including time in axis are sorted as time series plot... as I remember.
dat %>% 
  filter(!is.na(rate) & weeks_reporting >=10 & disease=='Smallpox') %>%
  ggplot() +
  geom_line(aes(year, rate, group = state),  color = "grey50", 
            show.legend = FALSE, alpha = 0.5, size = 1) +
  scale_y_continuous(trans = "sqrt") + 
