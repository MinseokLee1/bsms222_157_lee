...
To use ggplot2 you will have to learn several functions and arguments. These are hard to memorize, so we highly recommend you have the a [ggplot2 sheet cheat handy](https://www.rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf). You can get a copy [here](https://www.rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf) or simply perform an internet search for “ggplot2 cheat sheet”.


## 8.1 The components of a graph

We will construct a graph that summarizes the US murders dataset that looks like this:
[image1](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-plot-1.png)
...
Geometry function names follow the pattern: \geom\_\X\ where X is the name of the geometry. Some examples include geom_point, geom_bar and geom_histogram.
