---
title: "Ch9 Visualizing data distributions"
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/state-region-distribution-1.png)
...
F(a)=Pr(x<=a)
Here is a plot of F for the male heignt data:
[link](https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/height-histogram-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/example-of-smoothed-density-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-data-histogram-1-1.png)

The smaller we make the bins, the smoother the histogram gets. Here are the histograms with bin width of 1, 0.5 and 0.1:
[link](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-data-histogram-2-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-density-1-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/smooth-density-2-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/densities-different-smoothness-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/area-under-curve-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/example-of-smoothed-density-2-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/two-densities-one-plot-1.png)
...
[9.7-1](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-exercise-1.png)
...
[9.7-2](https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-exercise-1.png)
...
[9.7-3](https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-exercise-2-1.png)
...
[9.7-4](https://rafalab.github.io/dsbook/book_files/figure-html/height-histogram-exercise-1.png)
...
[9.7-5](https://rafalab.github.io/dsbook/book_files/figure-html/density-exercise-1.png)
...
[9.7-6](https://rafalab.github.io/dsbook/book_files/figure-html/density-exercise-2-1.png)
...
Rather than using data, the normal distribution is defined with a mathematical formula. For any interval  (a,b), the proportion of values in that interval can be computed using some formula.
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/normal-distribution-density-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/data-and-normal-densities-1.png)
...
First let’s define the theoretical quantiles for the normal distribution. In statistics books we use the symbol Φ(x) to define the function that gives us the probability of a standard normal distribution being smaller than x. So, for example,
Φ(-1.96)=0.025 and
Φ(1.96)=0.975. In R, we can evaluate Φ using the pnorm function:
```{r}
pnorm(-1.96)
```
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/hist-qqplot-non-normal-data-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/first-boxplot-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/female-male-boxplots-1.png)
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/histogram-qqplot-female-heights-1.png)
...
length(female)
```
There are 812 measurments for 'male', and 238 for 'female'.
...
h_percentile<-as.data.frame(cbind(female_percentiles, male_percentiles))
h_percentile
```

3. Study the following boxplots showing population sizes by country:
[9.15-1](https://rafalab.github.io/dsbook/book_files/figure-html/boxplot-exercise-1.png)
...
"America". Because the plot shown above has same intervals with plot which we use a log transformation.
...
mean(x<=81)-mean(x<79)
```
and calculate normal approximation.
```{r}
pnorm(81, mean=mean(x), sd=sd(x))-pnorm(79, mean=mean(x), sd=sd(x))
```
the actual proportion is about 2 times bigger than the approximation.
...
```{r}
pnorm(feet_to_inch(7), mean=69, sd=3)
```
1-(that value) is the proportion.
...
```{r}
10^9*(1-pnorm(feet_to_inch(7), mean=69, sd=3))
```
about 287.
...
```{r}
150/round(10^9*(1-pnorm(feet_to_inch(6)+8, mean=69, sd=3)), digit=0)
```
about 0.1%.
...
[link](https://rafalab.github.io/dsbook/book_files/figure-html/female-male-boxplots-geom-1.png)
