...
3. 전체적인 분포가 왼쪽 아래로 쏠려 있음을 볼 수 있다. SIFT를 바탕으로는 치명적이라고 해석되는 variant들이 PP2로 보았을 땐 그렇지 않은 경우는 있지만, 그 반대의 경우는 이 plot에서는 나타나지 않는다. 정확한 PP2와 SIFT의 산출 방법은 알지 못하지만, SIFT가 PP2에 비해 위험 요인을 좀 더 넓게 보고 있다고 해석할 수 있을 것이다.
