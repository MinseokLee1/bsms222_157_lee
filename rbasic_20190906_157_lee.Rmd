...
So the answer is "state", "abb", "region", "population", "total".
...
So the class of this object is "character".
...
In this way, we can see that "a" and "b" are the same.
...
```{r}
levels(reorder(region, murders$region, FUN = length))
```
